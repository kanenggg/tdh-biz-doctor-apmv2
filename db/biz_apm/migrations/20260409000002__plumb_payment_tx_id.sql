...
-- ============================================
-- Plumb payment_tx_id through create_appointment functions
-- ============================================
-- Slice 2 added payment_tx_id bigint NOT NULL DEFAULT 0 to
-- v2.appointment_payment_transaction. This slice updates the create
-- functions to accept an explicit p_payment_tx_id parameter and pass
-- it through, so new writes carry real values. The DEFAULT 0 stays
-- in place as a safety net.

-- 1) v2.create_appointment_internal
...
BEGIN
    ...
    -- Create appointment with caller-specified status
    ...
    -- Create payment transaction with explicit payment_tx_id
