...
use super::{BookingType, ConsultationChannel, PatientIdentity};
...
pub enum TerminationCode {
    #[serde(rename = "successfulSession")]
    SuccessfulSession,
    #[serde(rename = "patientAbsent")]
    PatientAbsent,
    #[serde(rename = "doctorAbsent")]
    DoctorAbsent { patient_joined_at: i64 },
    #[serde(rename = "bothPartiesAbsent")]
    BothPartiesAbsent,
